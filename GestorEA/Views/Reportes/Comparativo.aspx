<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Comparativo.aspx.cs" Inherits="GestorEA.Views.Reportes.Comparativo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Comparativo de Cotizaciones</li>
      </ol>
    </nav>
    <div ng-app="informeApp">
        <div ng-controller="informeController">
            <div class="container-fluid">
                <h6 style="color: #007bff">Comparativo</h6>
            </div>
            </br>
            <div class="container-fluid">
                ...
                <table class="table table-bordered" id="tableProductos">
                    ...
                    <tbody>
                        <tr ng-repeat="p in consultaSolicitudes">
                            <td><a href="ComparativoGrafico.aspx?solicitudId={{p.solicitud.SolicitudId}}">{{p.solicitud.SolicitudNumero}}</a></td>
    ...
    <script>
        ...
        app.controller("informeController", function ($scope) {
            ...
            $scope.consulta = function () {
                ...
                ConsultaAjax("ConsultaComparativo", "POST", function (source) {
                    if (!source) {
                        alert('No se ha completado la transaccion');
                    }
                    else {
