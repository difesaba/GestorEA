<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearCotizacion.aspx.cs" Inherits="GestorEA.Views.Cotizaciones.CrearCotizacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div ng-app="cotizacionApp">
        <div ng-controller="cotizacionController">
            <div class="container-fluid">
                <h7 style="color: #007bff">Cotización</h7>
            </div>
            <br />
            <div class="container-fluid">
                <div class="container-fluid" style="background-color: #f5f6fa; padding: 5px; color: #007bff">
                    <a href="InfEdicionCotizacion.aspx"><i class="fas fa-arrow-circle-left fa-2x"></i></a>
                ...
                <fieldset class="container-fluid border-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label id="consecutivo">{{consecutivo.NewCotizacion}}</label>
                            </div>
                            <div class="col-sm-3 tittle-head-color">
    ...
    <script>
        ...
        document.getElementById('txtSolicitud').textContent = ObtenerQueryString().solicitudId;
    ...
    <script>
        ...
        app.controller("cotizacionController", function ($scope) {
            ...
            $scope.nuevoConsecutivo = function () {
                var a = document.getElementById('txtFechaEntrega').value;
                ConsultaAjax("consecutivoCotizacion", "POST", function (source) {
                    if (!source) {
                        alert('No se ha completado la transaccion');
                    }
                    else {
                        $scope.consecutivo = source;
                        $scope.$apply();
                    }
                })
            }
            $scope.nuevoConsecutivo();
